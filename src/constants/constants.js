export const projects = [
  {
    title: "Movie Land",
    description:
      "Movieland is planning to develop a new web application using Next.js and Redux. This application will be an online platform for movie enthusiasts where they can find information about their favorite movies, watch trailers, read reviews and ratings.",
    image: "/images/1.png",
  ...
  },
  {
    title: "E-Commerce",
    description:
      " This application will be an online platform for customers to purchase products, browse product categories, and track their order status. The application's front-end will be developed using React.js and Next.js, providing faster performance and better SEO optimization through server-side rendering..",
    image: "/images/2.png",
